...
func TestDataRenderer2D_CalculateHallways(t *testing.T) {
	rooms := []Room2D{
		{Position: mat32.Vec2{X: 3, Y: 0}, Size: mat32.Vec2{X: 1, Y: 1}},
		{Position: mat32.Vec2{X: 3, Y: 2}, Size: mat32.Vec2{X: 1, Y: 1}},
		{Position: mat32.Vec2{X: 0, Y: 1}, Size: mat32.Vec2{X: 1, Y: 1}},
		{Position: mat32.Vec2{X: 0, Y: 3}, Size: mat32.Vec2{X: 1, Y: 1}},
	}
